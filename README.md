...
DBML language support for IntelliJ IDEs, focused on fast authoring and safer schema definitions.
...
- Manually:
  ...
  Download the [latest release](https://github.com/kangwooc/dbml-plugin/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
